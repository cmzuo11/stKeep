# -*- coding: utf-8 -*-
"""
Created on Sun Oct 2 15:40:25 2022
...
class intra_att_LR(nn.Module):
	def __init__(self, hidden_dim, attn_drop):
		...
		#nn.init.xavier_normal_(self.map_l.weight, gain=1.414)
		...
		#nn.init.xavier_normal_(self.map_r.weight, gain=1.414)
...
class CCI_attention(nn.Module):
	def __init__(self, cci_pairs, hidden_dim, attn_drop):
		super(CCI_attention, self).__init__()
	...
	def forward(self, sele_nei, ligand_exp, receptor_exp):
		...
		for z in range(self.cci_pairs):
			...
			#temp_emb  = temp_emb*receptor_exp[:,z].view(-1,1)
